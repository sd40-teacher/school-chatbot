...
# 최신 버전(1.x)에서 가장 안전한 임포트 경로들
from langchain.chains.combine_documents import create_stuff_documents_chain
from langchain.chains.retrieval import create_retrieval_chain

class SchoolChatbot:
    """성동글로벌경영고등학교 AI 챗봇 (LangChain 1.2.3 완벽 대응)"""
    ...
    def _create_qa_chain(self):
        ...
        system_prompt = (
            ...
            "정보가 없다면 학교(02-2252-1932)로 문의하라고 하세요.\n\n"
            "{context}"
        )
        ...
        return create_retrieval_chain(self.vectorstore.as_retriever(), combine_docs_chain)
    
    def ask(self, question):
        try:
            # invoke 시 input 키를 사용하여 질문 전달
